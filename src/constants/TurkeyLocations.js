export const DISTRICTS = {
    ...
    'Kocaeli': ['Başiskele', 'Çayirova', 'Darıca', 'Derince', 'Dilovası', 'Gebze', 'Gölcük', 'İzmit', 'Kandıra', 'Karamürsel', 'Kartepe', 'Körfez'],
...
export const TURKEY_CITIES = Object.keys(DISTRICTS).sort((a, b) => a.localeCompare(b, 'tr'));

export const getSortedCities = () => {
    const priority = ['İstanbul', 'Ankara', 'İzmir'];
    const others = TURKEY_CITIES
