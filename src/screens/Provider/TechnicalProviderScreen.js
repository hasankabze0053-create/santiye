...
export default function TechnicalProviderScreen() {
    ...
    const displayName = companyInfo?.company_name || profile?.full_name || 'Teknik Ofis';
    const providerInfo = {
        name: displayName,
    ...
    const loadRequests = async (isRefresh = false) => {
        ...
        try {
            ...
            console.error("Error fetching technical requests:", e);
        } finally {
        ...
        <View style={styles.listContainer}>
            {requests.length === 0 ? (
                <View style={styles.emptyState}>
                    <MaterialCommunityIcons name="office-building-cog" size={48} color="#333" />
                ...
                requests.map(item => (
                    ...
                    >
                        ...
                        <View style={styles.cardHeaderRow}>
                            <View style={styles.tagBadge}>
                                ...
                                <Text allowFontScaling={false} style={styles.tagText}>
                                    {(item.service_type || 'Genel Teknik Talep').toUpperCase()}
                                </Text>
                            </View>
                        ...
                        >
                            ...
                            >
                                <Text allowFontScaling={false} style={[styles.bidButtonText, { color: '#D4AF37' }]}>TALEBİ İNCELE</Text>
