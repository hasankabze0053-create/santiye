...
export default function HomeScreen({ navigation }) {
    ...
    return (
        <View style={[styles.container, { backgroundColor: isDarkMode ? '#000000' : '#EDE5D5' }]}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1, justifyContent: 'space-between' }}>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
                                ...
                                <TouchableOpacity style={[
                                    ...
                                    <View style={[styles.initialsContainer, { backgroundColor: isDarkMode ? '#1a1a1a' : '#EDE0CA' }]}>
            ...
            >
                ...
                >
                    ...
                    >
                        <LinearGradient
                            colors={isDarkMode ? ['#1a1a1a', '#000000'] : ['#FAF8F3', '#EDE5D5']}
