...
export const ConstructionService = {
    ...
    getIncomingOffers: async () => {
        try {
            ...
            const { data, error } = await supabase
                .from('construction_offers')
                .select('*, request:construction_requests!inner(id, district, neighborhood, city, user_id, is_campaign_active, campaign_unit_count, campaign_commercial_count), profiles:contractor_id(full_name, avatar_url, company_name)')
