...
const SharedRequestDetail = ({
    ...
    navigation,
    onDelete,
    onOfferAction, // For admin or specific actions
    showActions = true,
                    ...
                    <ScrollView contentContainerStyle={{ paddingBottom: 120 }} showsVerticalScrollIndicator={false}>
                        ...
                        >
                            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20 }}>
                                <View style={{ width: 52, height: 52, borderRadius: 16, backgroundColor: 'rgba(56, 189, 248, 0.1)', borderWidth: 1, borderColor: 'rgba(56, 189, 248, 0.4)', alignItems: 'center', justifyContent: 'center', marginRight: 14 }}>
                                    <MaterialCommunityIcons name="truck-fast" size={28} color="#38BDF8" />
                                </View>
                                <View style={{ flex: 1 }}>
                            ...
                            {/* Route Visualizer */}
                            <View style={{ position: 'relative', paddingLeft: 30, marginTop: 10 }}>
                                <View style={{ position: 'absolute', left: 10, top: 10, bottom: 10, width: 2, backgroundColor: 'rgba(56, 189, 248, 0.2)', borderStyle: 'dashed' }} />
    ...
    if (type === 'construction') {
                ...
                <View style={styles.container}>
                    ...
                    <SafeAreaView style={{ flex: 1 }} edges={['top']}>
                        ...
                        <ScrollView contentContainerStyle={{ paddingBottom: 120 }} showsVerticalScrollIndicator={false}>
                            ...
                            {isOwner && showActions && (
                                <View style={{ marginHorizontal: 16, marginBottom: 40 }}>
                                    <TouchableOpacity style={{ backgroundColor: 'rgba(239,68,68,0.07)', borderWidth: 1, borderColor: 'rgba(239,68,68,0.25)', borderRadius: 16, paddingVertical: 16, alignItems: 'center' }} onPress={onDelete}>
                                        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                                            <MaterialCommunityIcons name="trash-can-outline" size={20} color="#EF4444" />
                                            <Text allowFontScaling={false} style={{ color: '#EF4444', fontWeight: 'bold', fontSize: 15, letterSpacing: 1 }}>TALEBİ İPTAL ET / SİL</Text>
                                        </View>
        ...
        // =============================================
        // TADILAT (anahtar_teslim_tadilat)
        // =============================================
        return (
            <View style={styles.container}>
                <StatusBar barStyle={isDarkMode ? "light-content" : "dark-content"} />
